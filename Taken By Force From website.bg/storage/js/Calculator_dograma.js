...
function switchImage(configuration)
{
	...
	{
		case 0:
		source = "storage/calculatorImg/otv.jpg";
		typeOfTheWindow = 0;
		hasWing = 1;
		break;	
		case 1:
		source = "storage/calculatorImg/fix.jpg";
		typeOfTheWindow = 1;
		hasWing = 0;
		break;
		case 2:
		source = "storage/calculatorImg/fix_otv_fix.jpg";
		typeOfTheWindow = 2;
		hasWing = 1;
		break;
		case 3:
		source = "storage/calculatorImg/otv_fix.jpg";
		typeOfTheWindow = 3;
		hasWing = 1;
		break;
		case 4:
		source = "storage/calculatorImg/fix_otv_otv_fix.jpg";
		typeOfTheWindow = 4;
		hasWing = 2;
		break;
		case 5:
		source = "storage/calculatorImg/proz_fix_vrata.jpg";
		typeOfTheWindow = 5;
		...
		break;
		case 6:
		source = "storage/calculatorImg/otv_fix_otv.jpg";
		typeOfTheWindow = 6;
		hasWing = 2;
		break;
		case 7:
		source = "storage/calculatorImg/otv_fix_vrata.jpg";
		typeOfTheWindow = 7;
		doorW.style.visibility = "visible";
		doorH.style.visibility = "visible";
		hasWing = 1;
		break;
		case 8:
		source = "storage/calculatorImg/vrata.jpg";
		typeOfTheWindow = 8;
		hasWing = 1;
		break;
	}
