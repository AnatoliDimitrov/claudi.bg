  ...
  var beforeSign = "&lt;&nbsp;";					   //the sign to show the last image ;	last used:  ' &lt; '
  var nextSign = "&nbsp;&gt;";						   //the sign to show the next image ; last used: ' &gt; '
  var borderDV = 1;                                                 //border-width arround the viewer
  var spaceDV = 10;                                                 //space between the viewer and the inner-window
  ...
  var bgOpacity = 30;						   //opacity in percent
  ...
  DVObject.prototype.writeHtmlCode = function() {
    ...
    dv.htmlCode = '<div id="parentDV">\n' +
                    ...
                    '  <tr>' +
                    '   <td><div id="childDVBefore" onClick="dv.showLastImage();" title="Previous"><b>'+beforeSign+'</b></div></td>' +
