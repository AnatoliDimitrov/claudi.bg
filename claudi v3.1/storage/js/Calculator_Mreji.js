...
var netsTable = [ [25.9, 25.9, 32.9, 32.9],	// Static
                  [67.9, 67.9, 79.9, 79.9],	// Roleten horizontal
                  [55.9, 55.9, 69.9, 69.9],	// Roleten vertical
                  [53.9, 53.9, 59.9, 66.9]	// vrata napr. panti
				];

var netsColors = ["Бял", "Кафяв", "Имитация на дърво", "Цвят по RAL"];

var profile = [7, 7, 11, 11];	// Only Roller
